...
export const metadata: Metadata = {
  title: "About Us - ChronoVue",
  description: "Learn more about the ChronoVue team, our mission, vision, and the innovative AI career predictor and job readiness timeline we're building to help you succeed.",
  keywords: [
    "AI career predictor",
