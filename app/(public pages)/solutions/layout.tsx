...
export const metadata: Metadata = {
  title: "Career Growth Solutions - ChronoVue",
  description: "Solve career challenges with ChronoVue's AI-powered tools. Personalized roadmaps, market analysis, and visual timelines for students, changers, and professionals.",
  keywords: [
    "AI career predictor",
