...
export const metadata: Metadata = {
  title: "Sign In - ChronoVue",
  description: "Sign in to your ChronoVue account securely and easily. Follow our step-by-step guide to access your personalized AI career predictor and job readiness timeline.",
  keywords: [
    "AI career predictor",
