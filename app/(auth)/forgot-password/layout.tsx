...
export const metadata: Metadata = {
  title: "Forgot Password - ChronoVue",
  description: "Reset your ChronoVue account password securely and easily. Follow our step-by-step guide to regain access to your personalized AI career predictor and job readiness timeline.",
  keywords: [
    "AI career predictor",
